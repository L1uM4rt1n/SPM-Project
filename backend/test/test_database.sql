...
-- Grant necessary privileges to a user
GRANT ALL PRIVILEGES ON test_database.* TO 'root'@'localhost' IDENTIFIED BY 'root';
...
-- ... (other table creation and data loading statements)
